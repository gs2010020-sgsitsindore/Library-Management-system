...
<html lang = "eng">
	...
	<body style = "background-color:#d3d3d3;">
		...
		<nav class = "navbar navbar-default navbar-fixed-bottom">
			<div class = "container-fluid">
				<label class = "navbar-text pull-left">Developed By:Ridhi Mishra</label>
				<label class = "navbar-text pull-right">Library System &copy; All rights reserved 2023</label>
			</div>
		</nav>
	</body>
